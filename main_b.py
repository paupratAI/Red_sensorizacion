def parse_data(file_path):
    ...
    for section in sections:
        ...
        elif 'intersection_neighborhood' in header:
            for line in lines[1:]:
                i1, i2 = line.split()
...
def write_dat_file(intersections, paths, fixed, prohibited, path_flow, intersections_paths, intersection_neighborhood, dat_file_path):
